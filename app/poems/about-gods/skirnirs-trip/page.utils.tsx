const skirnirstrip = [
    {
        ...
        contentON: <span><p>
        Freyr, sonr Njarðar, hafði einn dag setzt í Hliðskjálf, ok sá um
        heima alla. Hann sá í Jötunheima ok sá þar mey fagra, þá er hon
        gekk frá skála föður síns til skemmu. Þar af fekk hann hugsóttir
        miklar. Skírnir hét skósveinn Freys. Njörðr bað hann kveðja Frey
        máls. Þá mælti Skaði:
        </p></span>,

        contentRU: <span><p>
        Фрейр, сын Ньёрда, сидел однажды на престоле Хлидскьяльв и
        обозревал все миры. Он взглянул на Ётунхейм и увидел красивую
        девушку. Она в это время шла из дома своего отца в кладовую.
        Увидев эту девушку, Фрейр очень опечалился. Скирниром звали слугу
        Фрейра. Ньёрд попросил его поговорить с Фрейром. Тогда Скади
        сказала:
        </p></span>
    },
    {
        ...
        у нашего сына<br />
        все разузнать —<br />
        чем так разгневан<br />
        муж многомудрый».</span>
    },
    {
        id: 3,
        number: '2.',
    ...
    },
    {
        ...
        владыка богов,<br />
        поведай, прошу я:<br />
        отчего дни за днями<br />
        один ты сидишь<br />
        в палате пустой?»</span>
    },
    {
        id: 5,
        number: '4.',
        ...
        о тягостном горе?<br />
        Альвов светило<br />
        всем радость несет,<br />
        но не любви моей».</span>
    },
    {
        id: 6,
        number: '5.',
    ...
    },
    {
        ...
        contentON: <span><p>
        Skírnir reið í Jötunheima til Gymisgarða. Þar váru hundar ólmir ok
        bundnir fyrir skíðgarðs hliði, þess er um sal Gerðar var. Hann
        reið at þar, er féhirðir sat á haugi, og kvaddi hann:
        </p></span>,

        contentRU: <span><p>
        Скирнир поскакал в Ётунхейм к жилищу Гюмира. Там были злые псы,
        привязанные у ворот ограды, окружавшей дом Герд. Он подъехал к
        пастуху, сидевшему на холме, и приветствовал его:
        </p></span>
    },
    {
        id: 13,
    ...
    },
    {
        ...
        если сюда<br />
        путь я направил?<br />
        До часа последнего<br />
        век мой исчислен<br />
        и жребий измерен».</span>
    },
    {
        id: 16,
        number: '14.',
    ...
    },
    {
        ...
        сквозь бурное пламя<br />
        и к нам прискакал?»</span>
    },
    {
        id: 20,
        number: '18.',
    ...
    },
    {
        ...
        но если с Гюмиром<br />
        встретишься ты,<br />
        вы оба, я знаю,<br />
        схватку затеете».</span>
    },
    {
        id: 27,
        number: '25.',
    ...
    },
    {
        ...
        Хель озирая;<br />
        еда тебе будет<br />
        противней, чем змеи<br />
        для взора людского!</span>
    },
    {
        id: 30,
        number: '28.',
        ...
        Прославишься больше,<br />
        чем сторож богов,<br />
        сквозь решетку глядящая!</span>
    },
    {
        id: 31,
        number: '29.',
    ...
    },
    {
        ...
        будешь всегда<br />
        безвольно плестись,<br />
        неизбежно плестись;<br />
        не радость познаешь,<br />
        но тяжкое горе<br />
        и скорбные слезы.</span>
    },
    {
        id: 33,
        number: '31.',
    ...
    },
    {
        ...
        sjalfir ásliðar,<br />
        hvé ek fyrbýð,<br />
        hvé ek fyrirbanna<br />
        manna glaum mani,<br />
        manna nyt mani.</span>,

        contentRU: <span className="flex w-40">Слушайте, ётуны,<br />
        слушайте, турсы,<br />
        Суттунга семя,<br />
        и сами асы!<br />
        Запрет налагаю,<br />
    ...
    },
    {
        ...
        тихая роща,<br />
        знакомая нам;<br />
        через девять ночей<br />
        там Герд подарит<br />
        любовь сыну Ньёрда».</span>
    },
    {
        id: 42,
        class:"m-7",
        ...
        contentON: <span><p>
        Þá reið Skírnir heim. Freyr stóð úti ok kvaddi hann ok spurði
        tíðenda:
        </p></span>,

        contentRU: <span><p>
        Тогда Скирнир поехал назад. Фрейр стоял у входа и приветствовал
        его и спросил, что слышно:
        </p></span>
    },
    {
        id: 43,
    ...
    },
    {
        ...
        две ночи длиннее,<br />
        как вытерплю три!<br />
        Часто казался мне<br />
        месяц короче,<br />
        чем ночи предбрачные».</span>
    },
];
