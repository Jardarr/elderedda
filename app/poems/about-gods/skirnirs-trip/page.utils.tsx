const skirnirstrip = [
    {
        ...
        contentRU: <span><p>
        Фрейр, сын Ньерда, сидел однажды на престоле Хлидскьяльв и
        обозревал все миры. Он взглянул на етунхейм и увидел красивую
        ...
        Фрейра. Ньерд попросил его поговорить с Фрейром. Тогда Скади
        сказала:
        </p></span>
    },
    {
    ...
    },
    {
        ...
        contentRU: <span><p>
        Скирнир поскакал в етунхейм к жилищу Гюмира. Там были злые псы,
