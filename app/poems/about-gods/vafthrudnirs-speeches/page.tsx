...
export const metadata: Metadata = {
	title: "Jardarr | Речи Вафтруднира",
...
export default function VafthrudnirsSpeeches() {
  return (
    <main className="flex items-center justify-center text-sm md:text-base">
      ...
      <span className="hidden sm:flex text-xs text-neutral-500"><a className="hover:text-sky-500" href="/">Jardarr Elder Edda</a>&nbsp;/&nbsp;<a className="hover:text-sky-500" href="/poems/about-gods">Goðakvæði</a>&nbsp;/&nbsp;<span>Vafþrúðnismál</span></span>
        <div className="m-8 text-3xl sea-color text-center font-bold">
          <h1>Vafþrúðnismál</h1>
          <h2>Речи Вафтруднира</h2>
        </div>
