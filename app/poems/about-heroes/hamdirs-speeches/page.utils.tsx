const hamdirsspeeches = [
    ...
    },
    {
        ...
        contentRU: (
            <span className="flex w-40">
                ...
                над ним ты сидела,
                <br />
                горько скорбя, —<br />в том Гуннар виновен!
            </span>
        ),
    },
    {
    ...
    },
    {
        ...
        contentRU: (
            <span className="flex w-40">
                ...
                ты, Гудрун, оплачешь,
                <br />
                всадников смелых! —<br />к смерти мы близки».
            </span>
        ),
    },
    {
    ...
    },
    {
        ...
        contentON: (
            <span>
                <p className="mb-2">Þetta eru kölluð Hamðissmál in fornu.</p>
            </span>
        ),
