const thefirstsongofhelgatheslayerofhunding = [
    {
        ...
        contentRU: (
            <span>
                <p className="mb-2">Здесь начинается Песнь о Хельги, убийце Хундинга и Хедбродда.</p>
                <p>Песнь о Вельсунгах:</p>
            </span>
        ),
    },
    {
...
export { thefirstsongofhelgatheslayerofhunding };
