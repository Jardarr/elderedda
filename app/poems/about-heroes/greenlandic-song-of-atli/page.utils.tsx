const greenlandicsongofatli = [
    {
        ...
        contentRU: (
            <span>
                <p>
                    Гудрун, дочь Гьюки, отомстила за своих братьев, как об этом много рассказывалось: она убила сначала сыновей Атли, а потом самого Атли и сожгла его палаты и всю
                    его дружину. Об этом сложена такая песнь:
                </p>
            </span>
        ),
    },
    ...
    },
    {
        ...
        contentON: (
            <span>
                <p className="mb-2">Enn segir gleggra í Atlamálum inum grænlenzkum.</p>
            </span>
        ),

        contentRU: (
            <span>
                <p>Еще подробнее об этом рассказано в Гренландских Речах Атли.</p>
            </span>
        ),
    },
];
