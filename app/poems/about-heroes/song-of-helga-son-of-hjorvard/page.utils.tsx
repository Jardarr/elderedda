const songofhelgasonofhjorvard = [
    ...
    },
    {
        ...
        contentRU: <>«Сигрлинн ты видел ли,
        Свафнира дочь?
        Нет ее краше
        в целой вселенной!
        Хоть и красивей
    ...
    },
    {
        ...
        <br />
        Fuglinn kvað:<br />
        «Mun ek, ef mik buðlungr<br />
        blóta vildi<br />
        ok kýs ek þats vil<br />
        ór konungs garði.»</>,

        contentRU: <>Атли сказал:<br />
        «Мудрая птица,<br />
        будешь ли дальше<br />
        беседовать с Атли,<br />
        Идмунда сыном?»<br />
        <br />
        Птица сказала:<br />
        «Буду, коль жертву<br />
        князь принесет мне;<br />
        сама ее выберу<br />
        у конунга в доме».</>
    },
    {
    ...
    },
    {
        ...
        contentON: <>Gneggja myndir þú, Atli,
    ...
    },
    {
        ...
        contentON: <>
        <p>Þat kvað Helgi, því at hann grunaði um feigð sína ok þat, at fylgjur hans höfðu vitjat Heðins, þá er hann sá konuna ríða varginum.</p>
        <p>Álfr hét konungr, son Hróðmars, er Helga hafði völl haslaðan á Sigarsvelli á þriggja nátta fresti. Þá kvað Helgi:</p>
        </>,
    ...
    },
    {
        ...
        contentON: <><p>Helgi ok Sváfa, er sagt, at væri endrborin.</p></>,

        contentRU: <><p>Говорят, что Хельги и Свафа вновь родились.</p></>
    },
];
