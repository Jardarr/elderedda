const songofhelgasonofhjorvard = [
    {
        ...
        contentON: (
            <span>
                ...
                <p className="mb-2">
                    ...
                    Iðmundr hét jarl hans. Atli var hans son, er fór at biðja Sigrlinnar til handa konungi. Hann dvalðist vetrlangt með Sváfni konungi. Fránmarr hét þar jarl,
                    fóstri Sigrlinnar. Dóttir hans hét Álof. Jarlinn réð, at meyjar var synjat, ok fór Atli heim.
                </p>
                <p className="mb-2">
                    Atli jarls son stóð einn dag við lund nökkurn, en fugl sat í limunum uppi yfir hánum ok hafði heyrt til, at hans menn kölluðu vænstar konur þær, er Hjörvarðr
                    átti. Fuglinn kvakaði, en Atli hlýddi, hvat hann sagði. Hann kvað:
                </p>
            </span>
        ),
        ...
        contentRU: (
            <span>
                <p className="mb-2">
                    Конунга звали Хьервард. Было у него четыре жены. Одну звали Альвхильд, сын их звался Хедин. Другую звали Серейд, их сын прозывался Хумлунг. Третья была Синриод,
                    и у них был сын Хюмлинг. Конунг Хьервард дал обет жениться на самой красивой женщине. Он узнал, что у конунга Свафнира есть дочь, которая всех прекраснее. Звали
                    ее Сигрлинн.
                </p>
                <p className="mb-2">
                    Идмундом звали его ярла. У него был сын Атли. Он поехал сватать Сигрлинн от имени конунга. Он прожил зиму у конунга Свафнира. Ярла, который воспитывал Сигрлинн,
                    звали Франмаром. У него была дочь по имени Алев. Ярл дал совет отказать Хьерварду. И Атли уехал домой.
                </p>
                <p className="mb-2">
                    Атли, сын ярла, стоял однажды у какой-то рощи, а над ним в ветвях сидела птица. Она слышала, что его люди жен Хьерварда называют красивейшими женщинами. Птица
                    защебетала, и Атли стал слушать ее. Птица сказала:
                </p>
            </span>
        ),
    },
    ...
    },
    {
        ...
        contentON: (
            <span>
                <p className="mb-2">Þetta var, áðr Atli færi, en er hann kom heim ok konungr spurði hann tíðenda, hann kvað:</p>
            </span>
        ),

        contentRU: (
            <span>
                <p className="mb-2">Это было до того, как Атли поехал. А когда он вернулся и конунг спросил его, какие вести, — он ответил:</p>
            </span>
        ),
    },
    {
    ...
    },
    {
        ...
        contentON: (
            <span>
                <p className="mb-2">
                    Konungr bað, at þeir skyldu fara annat sinn. Fór hann sjálfr. En er þeir kómu upp á fjall, ok sá á Sváfaland landsbruna ok jóreyki stóra. Reið konungr af
                    fjallinu fram í landit ok tók náttból við á eina. Atli helt vörð ok fór yfir ána. Hann fann eitt hús. Fugl mikill sat á húsinu ok gætti, ok var sofnaðr. Atli
                    skaut spjóti fuglinn til bana, en í húsinu fann hann Sigrlinn konungs dóttur ok Álofu jarls dóttur ok hafði þær báðar braut með sér. Fránmarr jarl hafði hamazt
                    í arnar líki ok varit þær fyrir hernum með fjölkynngi. Hróðmarr hét konungr, biðill Sigrlinnar. Hann drap Sváfakonung ok hafði rænt ok brent landit. Hjörvarðr
                    konungr fekk Sigrlinnar, en Atli Álofar.
                </p>
                <p className="mb-2">
                    Hjörvarðr ok Sigrlinn áttu son mikinn ok vænan. Hann var þögull. Ekki nafn festist við hann. Hann sat á haugi. Hann sá ríða valkyrjur níu ok var ein
                    göfugligust. Hon kvað:
                </p>
            </span>
        ),
        ...
        contentRU: (
            <span>
                <p className="mb-2">
                    Конунг велел им поехать во второй раз и сам поехал с ними. А когда они поднялись на гору, то увидели повсюду в Сваваланде пожары и большие клубы пыли от
                    скачущих коней. Конунг спустился с горы и остановился на ночь у одной речки. Атли остался на страже. Он перешел речку и увидел дом. Большая птица сидела на
                    доме, она сторожила его и заснула. Атли метнул копье в птицу и убил ее. А в доме он нашел Сигрлинн, дочь конунга, и Алев, дочь ярла, и увез обеих. Это ярл
                    Франмар обратился в орла и защищал их от воинов колдовством.
                </p>
                <p className="mb-2">Звали Хродмаром конунга, который сватался к Сигрлинн. Он убил конунга свавов, а страну разграбил и пожег.</p>
                <p className="mb-2">Конунг Хьервард женился на Сигрлинн, а Атли — на Алев.</p>
                <p>
                    У Хьерварда и Сигрлинн был сын, высокий и красивый. Он был молчалив. У него не было имени. Однажды он сидел на кургане и увидел, что скачут девять валькирий, и
                    одна из них была самой статной. Она сказала:
                </p>
            </span>
        ),
    },
    ...
    },
    {
        ...
        contentRU: (
            <span>
                <p>
                    Одного конунга звали Эйлими. У него была дочь Свафа. Она была валькирией и носилась по небу и по морю. Она дала Хельги имя и часто потом защищала его в битвах.
                    Хельги сказал:
                </p>
            </span>
        ),
    ...
    },
    {
        ...
        contentON: (
            <span>
                <p className="mb-2">
                    Hjörvarðr svarar, at hann mundi fá lið Helga, ef hann vill hefna móðurföður síns. Þá sótti Helgi sverðit, er Sváfa vísaði hánum til. Þá fór hann ok Atli ok
                    felldu Hróðmar ok unnu mörg þrekvirki. Hann drap Hata jötun, er hann sat á bergi nökkuru. Helgi ok Atli lágu skipum í Hatafirði. Atli helt vörð inn fyrra hluta
        ...
        contentRU: (
            <span>
                <p>
                    Хьервард сказал, что даст Хельги воинов, если тот хочет отомстить за деда. Тогда Хельги добыл меч, на который указала ему Свава. Они поехали с Атли, убили
                    Хродмара и совершили много подвигов. Хельги убил великана Хати, который сидел на некоей горе. Они стояли на якоре в Хатафьорде. Атли был на страже первую
                    половину ночи. Хримгерд, дочь Хати, сказала:
                </p>
            </span>
        ),
    },
    ...
    },
    {
        ...
        contentON: (
            <span>
                <p className="mb-2">
                    Helgi konungr var allmikill hermaðr. Hann kom til Eylima konungs ok bað Sváfu dóttur hans. Þau Helgi ok Sváfa veittust várar ok unnust furðu mikit. Sváfa var
                    heima með feðr sínum, en Helgi í hernaði. Var Sváfa valkyrja enn sem fyrr.
                </p>
                <p className="mb-2">Heðinn var heima með föður sínum, Hjörvarði konungi, í Nóregi.</p>
                <p className="mb-2">Heðinn fór einn saman heim ór skógi jólaaftan ok fann trollkonu. Sú reið vargi ok hafði orma at taumum ok bauð fylgð sína Heðni.</p>
                <p className="mb-2">«Nei,» sagði hann.</p>
                <p className="mb-2">Hon sagði: «Þess skaltu gjalda at bragarfulli.»</p>
                <p className="mb-2">
                    Um kveldit óru heitstrengingar. Var fram leiddr sónargöltr. Lögðu menn þar á hendr sínar ok strengðu menn þá heit at bragarfulli. Heðinn strengði heit til Sváfu
                    Eylimadóttur, unnustu Helga, bróður síns, ok iðraðisk svá mjök, at hann gekk á braut villistígu suðr á lönd ok fann Helga bróður sinn. Helgi kvað:
                </p>
            </span>
        ),
        ...
        contentRU: (
            <span>
                <p className="mb-2">
                    Конунг Хельги был величайший воин. Он пришел к конунгу Эйлими и посватался к Свафе, его дочери. Хельги и Свафа обменялись обетами и любили друг друга очень
                    сильно. Свафа оставалась дома с отцом, а Хельги воевал. Свафа была по-прежнему валькирией. Хедин жил дома, в Норвегии, со своим отцом, конунгом Хьервардом.
                </p>
                <p>
                    Ехал Хедин домой из леса в вечер под Йоль и встретил женщину-тролля. Она ехала на волке, и змеи были у нее удилами. Она предложила Хедину сопровождать его.
                    «Нет!» — сказал он. Она сказала: «За это ты заплатишь, когда будешь пить обетную чашу!» Вечером стали давать обеты. Привели жертвенного вепря. Люди возлагали на
                    него руку и давали обеты, выпивая обетную чашу. Хедин дал обет жениться на Свафе, дочери Эйлими, возлюбленной Хельги, его брата. И так начал в том раскаиваться,
                    что ушел по дикой тропе на юг. Он встретил Хельги, своего брата. Хельги сказал:
                </p>
            </span>
        ),
    },
    ...
    },
    {
        ...
        contentON: (
            <span>
                <p className="mb-2">Þat kvað Helgi, því at hann grunaði um feigð sína ok þat, at fylgjur hans höfðu vitjat Heðins, þá er hann sá konuna ríða varginum.</p>
                <p className="mb-2">Álfr hét konungr, son Hróðmars, er Helga hafði völl haslaðan á Sigarsvelli á þriggja nátta fresti. Þá kvað Helgi:</p>
            </span>
        ),
        ...
        contentRU: (
            <span>
                ...
                <p>Альвом звали конунга, сына Хродмара. Это он оградил ореховыми ветвями поле на Сигарсвеллире, чтоб биться там с Хельги на третью ночь. Тогда сказал Хельги:</p>
            </span>
        ),
    },
    {
    ...
    },
    {
        ...
        contentON: (
            <span>
                <p className="mb-2">Þar var orrosta mikil, ok fekk þar Helgi banasár.</p>
            </span>
        ),
