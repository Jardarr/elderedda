const brynhildsjourneytohel = [
    {
        ...
        contentON: (
            <span>
                <p className="mb-2">
                    ...
                    Svá er sagt, at Brynhildr ók með reiðinni á helveg ok fór um tún, þar er gýgr nökkur bjó. Gýgrin kvað:
                </p>
            </span>
        ),
        ...
        contentRU: (
            <span>
                <p>
                    После смерти Брюнхильд было сложено два костра; один — для Сигурда, и этот костер сгорел первым, а Брюнхильд была сожжена на другом костре. Она была в повозке,
                    увешанной драгоценными тканями. Говорят, что Брюнхильд поехала в этой повозке в Хель мимо двора, в котором жила некая великанша. Великанша сказала:
                </p>
            </span>
        ),
    },
