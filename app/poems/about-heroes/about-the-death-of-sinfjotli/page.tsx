...
export const metadata: Metadata = {
	title: "Jardarr | О смерти Синфьётли",
...
export default function AboutTheDeathOfSinfjotli() {
  return (
    <main className="flex items-center justify-center text-sm md:text-base">
      ...
      <span className="hidden sm:flex text-xs text-neutral-500"><a className="hover:text-sky-500" href="/">Jardarr Elder Edda</a>&nbsp;/&nbsp;<a className="hover:text-sky-500" href="/poems/about-heroes">Hetjukvæði</a>&nbsp;/&nbsp;<span>Frá dauða Sinfjötla</span></span>
        <div className="m-8 text-3xl sea-color text-center font-bold">
          <h1>Frá dauða Sinfjötla</h1>
          <h2>О смерти Синфьётли</h2>
        </div>
