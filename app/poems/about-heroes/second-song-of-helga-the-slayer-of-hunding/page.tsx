        ...
        <main className="flex items-center justify-center text-sm md:text-base">
            <div className="flex flex-col w-[600px] rounded-md mt-20">
                <span className="hidden sm:flex text-xs text-neutral-500">
                    ...
                    &nbsp;/&nbsp;<span>Helgakviða Hundingsbana önnur</span>
                </span>
                <div className="m-8 text-3xl sea-color text-center font-bold">
                    <h1 style={{ fontFamily: "Elementary, sans-serif" }}>Helgakviða Hundingsbana önnur</h1>
                    <h2 className="mt-2" style={{ fontFamily: "Feofan, sans-serif" }}>Вторая Песнь о Хельги убийце Хундинга</h2>
                </div>
