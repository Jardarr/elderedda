const sigdrivasspeeches = [
    {
        ...
        contentON: (
            <span>
                <p className="mb-2">
                    ...
                    þá stóð þar skjaldborg ok upp ór merki. Sigurðr gekk í skjaldborgina ok sá , at þar lá maðr ok svaf með öllum hervápnum. Hann tók fyrst hjálminn af höfði hánum.
                    Þá sá hann, at þat var kona. Brynjan var föst sem hon væri holdgróin. Þá reist hann með Gram frá höfuðsmátt brynjuna í gögnum niðr ok svá út í gögnum báðar
                    ermar. Þá tók hann brynju af henni, en hon vaknaði, ok settist hon upp ok sá Sigurð ok mælti:
                </p>
            </span>
        ),
        ...
        contentRU: (
            <span>
                <p>
                    Сигурд поднялся на гору Хиндарфьялль и направился на юг во Фраккланд. На горе он увидел яркий свет, как будто горел огонь, и зарево стояло до самого неба. Когда
                    он приблизился, он увидел ограду из щитов и в ограде — знамя. Сигурд вошел в огражденное место и увидел, что там лежит и спит человек в доспехах. Сигурд сперва
                    снял шлем с его головы, и тут он увидел, что это женщина. Кольчуга сидела на ней крепко, словно приросла к телу. Тогда он рассек Грамом кольчугу от ворота вниз
                    и еще поперек, по обоим рукавам. Затем он снял с нее кольчугу, и женщина проснулась, села, увидела Сигурда и сказала:
                </p>
            </span>
        ),
    },
    ...
    },
    {
        ...
        contentON: (
            <span>
                <p className="mb-2">Sigurðr settist niðr ok spyrr hana nafns. Hon tók þá horn fullt mjaðar ok gaf honum minnisveig:</p>
            </span>
        ),
    ...
    },
    {
        ...
        contentON: (
            <span>
                <p className="mb-2">
                    Hon nefndisk Sigrdrífa, ok var valkyrja. Hon sagði at tveir konungar bǫrðusk. Hét annarr Hjálm-Gunnarr. Hann var þá gamall ok inn mesti hermaðr, ok hafði Óðinn
                    honum sigri heitit. En annarr hét Agnarr, Hauðu bróðir, er vætr engi vildi þiggja. Sigrdrífa feldi Hjálm-Gunnar í orrostunni. En Óðinn stakk hana svefnþorni í
                    hefnd þess ok kvað hana aldri skyldu síðan sigr vega í orrostu ok kvað hana giptask skyldu. ‘En ek sagðak honum at ek strengðak heit þar í mót, at giptask øngum
                    þeim manni er hræðask kynni.’
                </p>
                <p className="mb-2">Hann segir ok biðr hana kenna sér speki, ef hon vissi tíðindi ór ǫllum heimum.</p>
            </span>
        ),
        ...
        contentRU: (
            <span>
                <p className="mb-2">
                    Она назвалась Сигрдривой и была валькирией. Она рассказала, что два конунга вели войну: одного звали Хьяльм-Гуннар, он тогда был старым и очень воинственным, и
                    Один обещал ему победу; другого звали Агнар, он был братом Ауды, и его никто не хотел взять под свою защиту. Сигрдрива погубила в битве Хьяльм-Гуннара. А Один,
                    в отместку за это, уколол ее шипом сна и сказал, что никогда больше она не победит в битве и что будет выдана замуж. «Но я ответила ему, что дала обет не
                    выходить замуж ни за кого, кто знает страх».
                </p>
