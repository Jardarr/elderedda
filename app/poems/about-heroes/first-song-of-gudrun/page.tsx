...
export const metadata: Metadata = {
    title: "Gjallarbru | Первая Песнь о Гудрун",
        ...
        <main className="flex items-center justify-center text-sm md:text-base">
            <div className="flex flex-col w-[600px] rounded-md mt-20">
                <span className="hidden sm:flex text-xs text-neutral-500">
                    ...
                    &nbsp;/&nbsp;<span>Guðrúnarkviða in fyrsta</span>
                </span>
                <div className="m-8 text-3xl sea-color text-center font-bold">
                    <h1 style={{ fontFamily: "Elementary, sans-serif" }}>Guðrúnarkviða in fyrsta</h1>
                    <h2 className="mt-2" style={{ fontFamily: "Feofan, sans-serif" }}>Первая Песнь о Гудрун</h2>
                </div>
