const songaboutrig = [
    {
        ...
        contentON: (
            <span>
                <p className="mb-2">
                    ...
                    Rígr. Eftir þeiri sögu er kvæði þetta:
                </p>
            </span>
        ),
        ...
        contentRU: (
            <span>
                <p>
                    Люди рассказывают в древних сагах, что один из асов, тот, которого звали Хеймдалль, шел однажды своей дорогой вдоль берега одного озера, пришел на какой-то двор
                    и назвался Ригом. Об этом рассказывается в следующей песни:
                </p>
            </span>
        ),
    },
