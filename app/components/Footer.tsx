    ...
    <div className="flex flex-col lg:justify-between lg:flex-row md:text-xs text-gray-500 text-xs">
      <div className="flex justify-center flex-col">
        <div className="flex justify-center items-center flex-wrap">
          <Link className="px-2 hover:text-gray-300" href="/poems/about-gods">
            Goðakvæði
          </Link>
          <Link className="px-2 hover:text-gray-300" href="/poems/about-heroes">
            Hetjukvæði
          </Link>
          <Link className="px-2 hover:text-gray-300" href="/poems/edda-songs">
            Eddukvæði
          </Link>
          <Link className="px-2 hover:text-gray-300" href="/poems/edda-app">
            Viðbætir
          </Link>
          <Link className="px-2 hover:text-gray-300" href="/poems/poetry">
            Ljóð
          </Link>
