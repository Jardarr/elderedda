const incitementofgudrun = [
    {
        ...
        contentON: (
            <span>
                ...
                <p className="mb-2">
                    ...
                    Bikki. Hann réð þat, at Randvér konungs son skyldi taka hana. Þat sagði Bikki konungi. Konungr lét hengja Randvé, en troða Svanhildi undir hrossa fótum. En er
        ...
        contentRU: (
            <span>
                <p className="mb-2">
                    Гудрун пошла тогда к морю, после того как она убила Атли. Она вошла в море и хотела покончить с собой. Но она не могла утонуть. Ее отнесло через фьорд в землю
                    конунга Йонакра. Он на ней женился.
                </p>
                <p>
                    Их сыновей звали Серли, Эрп и Хамдир. Там же воспитывалась и Сванхильд, дочь Сигурда. Ее выдали замуж за ермунрекка Могучего. У него был советник Бикки. Бикки
                    посоветовал Рандверу, сыну конунга, овладеть ею и все рассказал конунгу. Тот велел повесить Рандвера и приказал, чтобы Сванхильд была растоптана конями. Когда
                    об этом узнала Гудрун, она обратилась к своим сыновьям.
                </p>
            </span>
        ),
    },
