const PoemsLinks = [
    ...
    { href: "/poems/poetry", text: "Ljóð", aria: "Поэзия" },
    { href: "/poems/stora-edda", text: "Stóra Edda", aria: "Книга Большая Эдда" },
    { href: "/poems/on-dictionary", text: "Orðabók", aria: "Словарь Древнеисландского языка" },
];

export default PoemsLinks;
